...
{#if loaded}
  ...
  <div class="relative" transition:fade={{ duration: 600 }}>
    <div
      class="h-16 px-4 flex items-center justify-between bg-white border-b
      shadow-sm">
      ...
      <div class="space-x-2 flex items-center">
        <div class="relative">
          ...
          {#if showPopup}
            <div
              ...
              <div class="px-4 py-1 border-b hover:bg-gray-200">
                <a class="text-gray-600" href="/models/{userData.model.id}">
                  Profile
                </a>
              </div>
              <div class="px-4 py-1 hover:bg-gray-200">
                <a class="text-gray-600" href="/accounts/signout">Sign out</a>
              </div>
            </div>
          {/if}
        </div>
        ...
        <span class="text-xs capitalize sm:text-sm">
          {userData.model.first_name} {userData.model.last_name}
        </span>
      </div>
    ...
    <div class="min-h-full flex bg-gray-100">
      ...
      <div class="w-full mb-4 px-4 py-2 sm:mt-4">
