...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main/infiniteScroll.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils */ "./src/main/utils.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  io.observe(document.querySelector('footer')); // Lazy load initial imgs

  var cards = Array.from(cardContainer.children);
  cards.forEach(function (card) {
    Object(_utils__WEBPACK_IMPORTED_MODULE_7__["lazyLoad"])(card.children[0].children[0], {
  ...
  function getModels() {
    fetch("/models/subset?start=".concat(start, "&count=").concat(count)).then(function (blob) {
      return blob.json();
    }).then(function (res) {
      start = count + 1;
      count = count + 12;
      ...
      models.forEach(function (model) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_7__["createCard"])(model, cardContainer);
      });
    });
  }
});
