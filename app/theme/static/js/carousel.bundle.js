...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main/carousel.js");
/******/ })
/************************************************************************/
/******/ ({
...
var prevButton = document.querySelector('.carousel-left');
var nextButton = document.querySelector('.carousel-right');
var slides = Array.from(track.children);
var slideWidth = slides[0].getBoundingClientRect().width; // If we have only one photo in the slide
// Hide the buttons
...
var moveToSlide = function moveToSlide(targetSlide, currentSlide) {
  var amountToMove = targetSlide.style.left;
...
prevButton.addEventListener('click', function () {
  ...
  var index = slides.indexOf(prevSlide); // Hide the prev button if we're at the first slide
...
nextButton.addEventListener('click', function () {
  var currentSlide = track.querySelector('.current-slide');
  var nextSlide = currentSlide.nextElementSibling; // Hide the next button if we're at the last slide

  var index = slides.indexOf(currentSlide) + 1;
