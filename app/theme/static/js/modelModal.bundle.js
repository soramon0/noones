...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main/modelModal.js");
/******/ })
/************************************************************************/
/******/ ({
...
var contactButton = document.getElementById('model-contact');
var backdrop = document.getElementById('model-backdrop');
var modal = document.getElementById('model-modal');
var contactForm = document.getElementById('model-form');
var sendContactButton = document.getElementById('send-contact');
...
function sendContactRequest(e) {
  ...
  fetch('/models/request', {
    ...
    headers: {
      'X-CSRFToken': js_cookie__WEBPACK_IMPORTED_MODULE_2___default.a.get('csrftoken'),
      mode: 'same-origin'
    }
  }).then(function (blob) {
    return blob.json();
...
/******/ });
//# sourceMappingURL=modelModal.bundle.js.map