...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/main/search.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils */ "./src/main/utils.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var io = new IntersectionObserver(handleIntersection, options);
  ...
  function getFilteredModels() {
    var pays = document.getElementById('id_pays').value;
    var ville = document.getElementById('id_ville').value;
    var sexe = document.getElementById('id_sexe').value;
    var cheveux = document.getElementById('id_cheveux').value;
    var yeux = document.getElementById('id_yeux').value;
    var taille = document.getElementById('id_taille').value;
    var searchParams = "pays=".concat(pays, "&ville=").concat(ville, "&sexe=").concat(sexe, "&cheveux=").concat(cheveux, "&yeux=").concat(yeux, "&taille=").concat(taille);
    fetch("/models/search?".concat(searchParams, "&start=").concat(start, "&count=").concat(count)).then(function (res) {
      return res.json();
    }).then(function (res) {
      start = count + 1;
      count = count + 12;
      var models = JSON.parse(res.models); // If we get no data stop fetching
      ...
      models.forEach(function (model) {
        Object(_utils__WEBPACK_IMPORTED_MODULE_5__["createCard"])(model, cardContainer);
      });
    });
  }
});
...
/*!***************************!*\
  !*** ./src/main/utils.js ***!
  \***************************/
/*! exports provided: lazyLoad, createCard, handleInfiniteIntersection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "handleInfiniteIntersection", function() { return handleInfiniteIntersection; });
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/core-js/modules/es.array.concat.js");
/* harmony import */ var core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_concat__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/modules/es.array.for-each */ "./node_modules/core-js/modules/es.array.for-each.js");
/* harmony import */ var core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_array_for_each__WEBPACK_IMPORTED_MODULE_1__);
...
function lazyLoad(targets) {
  ...
  function handle(enteries) {
    enteries.forEach(function (entry) {
      if (entry.isIntersecting) {
        if (entry.target.src) return; // TODO(karim): optimize this, a second thread
  ...
  var io = new IntersectionObserver(handle, options);
  io.observe(targets);
}
function createCard(_ref, parent) {
  var pk = _ref.pk,
      fields = _ref.fields;
  // Create Card
  ...
  var skewLine = document.createElement('div');
  ...
  var profileButton = document.createElement('a'); // Style Card
  ...
  profileButton.className = "px-4 py-3 text-xs rounded-lg bg-black hover:bg-gray-700 text-white uppercase tracking-wide"; // Add Content
  ...
  profileButton.href = "/models/".concat(pk); // Create Structure
...
function handleInfiniteIntersection(enteriesm, hasMore, cb) {
  if (enteries[0].isIntersecting) {
    if (hasMore) {
      setTimeout(function () {
        cb();
